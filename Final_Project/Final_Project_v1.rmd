...
Finally, we built a user-based collaborative filtering recommender model based on data for users which had rated at least 300 anime and anime which had been rating by at least 1,000 users.  
...
# create table
header <- sprintf("Top N recommendations for User: %s", id_sample)
# display the list of similar animes
